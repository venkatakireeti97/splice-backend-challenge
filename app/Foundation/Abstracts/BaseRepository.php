...
use App\Foundation\Contracts\IEloquentRepository;
...
abstract class BaseRepository implements IEloquentRepository
{
     ...
     */
    public function lengthAwarePaginate(int $perPage, array $columns = ['*']): LengthAwarePaginator
    {
        $query = $this->allQuery();
    ...
    {
        $direction = strtolower(Request::input()->get('direction', 'asc'));
    ...
    {
        $orderBy = Request::input()->get('sort_by');
